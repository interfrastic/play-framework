 ...
 * }</pre>
 * The presence of {@code mappedBy} marks this side of this {@code @OneToOne} as
 * analogous to {@code @OneToMany}, the "many" side of a {@code @OneToMany} /
 * {@code @ManyToOne} relationship, only with its cardinality limited to one.
 * <p>
